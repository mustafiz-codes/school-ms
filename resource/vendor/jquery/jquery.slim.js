...
var rTeachersprev = /^(?:Teachers|prev(?:Until|All))/,
...
jQuery.each( {
	...
	Teachers: function( elem ) {
		return dir( elem, "parentNode" );
	},
	TeachersUntil: function( elem, i, until ) {
	...
	jQuery.fn[ name ] = function( until, selector ) {
		...
		if ( this.length > 1 ) {
			...
			// Reverse order for Teachers* and prev-derivatives
			if ( rTeachersprev.test( name ) ) {
				matched.reverse();
			}
		}
